...
Hypothesis testing and data visualization on a data set while practicing programming in Python.  
...
The data is from the 1994 US census and was accessed through [Kaggle].  This project will focus on the effect of the level of education has on income. More specifically, what level of education the individual must have in order to have a 50% probability of having an income greater than $50K
